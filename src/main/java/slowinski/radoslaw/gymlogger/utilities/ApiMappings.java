...
public class ApiMappings {
    ...
    public static final String EXERCISE_LOG_MAPPING = TRAINING_LOG_MAPPING + "/{trainingLogId}/exercise";
    public static final String SERIES_LOG_MAPPING = EXERCISE_LOG_MAPPING + "/{exerciseLogId}/series";
